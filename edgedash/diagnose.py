...
def run_diagnostics() -> None:
    ...
    if dupes:
        ...
        print("  [OK] 0 cross-source duplicates found across different sources.")
    ...
    print("  " + "-" * 52)
    if issues:
        print(f"  [WARN] Found {len(issues)} listing(s) with data quality issues:")
        for bad in issues:
            missing_fields = []
        ...
        print("  [OK] All listings have valid non-empty title, company, and url.")
